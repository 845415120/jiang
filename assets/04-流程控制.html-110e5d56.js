...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="break-与-continue" tabindex="-1"><a class="header-anchor" href="#break-与-continue" aria-hidden="true">#</a> break 与 continue</h3><ul><li><code>break</code>：跳出当前循环，不再进行当前循环。</li><li><code>continue</code>：跳过本轮循环，进行当前循环的下一轮。</li><li><code>break</code> 与 <code>continue</code> 均可配合 <code>label</code> 语句使用来跳转循环。</li></ul>`,25),c=[l];function t(d,p){return a(),s("div",null,c)}const r=n(i,[["render",t],["__file","04-流程控制.html.vue"]]);export{r as default};
